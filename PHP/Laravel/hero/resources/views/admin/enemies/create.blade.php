...
@section('content')
    <h1>Creación de Enemigos</h1>

    <form action="{{route('admin.enemies.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="xp" id="xp" placeholder="Ingresar Experiencia..." required>
        </div>
        <div class="row">&nbsp;</div>
        <div class="form-group">
